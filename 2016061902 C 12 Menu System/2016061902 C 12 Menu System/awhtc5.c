...
Gist
 ...
 Unwatch 1
  Star 0
 Fork 0 AungWinnHtut/CipherCAD2003
 Code  Issues 0  Pull requests 0  Projects 0  Wiki  Settings Insights 
Branch: master Find file Copy pathCipherCAD2003/TC5.CPP
96a1fa6  on Aug 1, 2015
@AungWinnHtut AungWinnHtut adding old ciphercad2003 codes
1 contributor
RawBlameHistory     
950 lines (779 sloc)  24 KB
//TC5.CPP
//29-7 -2000	Beginning
//6 -11-2000	Update
//15-11-2000
...
enum  MENU{ EXIT=0 , FILE_ , PROGRAMMER , SYSTEM , SUPERVISOR , PROJECT , HELP_ };
...
void PROGRAMMER_Pull_Menu()
{
	 ...
	 switch(ch){
	      ...
	      case char(77) :  active_status_bar(3,1);  //PROGRAMMER
			       MAINMENU(4);    //--------->
			       break;
	      case char(6) : break;      //ctrl-f
	      case char(3) : break;       //ctrl-c
	      case char(19) :break;       //ctrl-s
	     // case char(75) :  Fore_Ground_window();
	     //		       active_status_bar(0,2);
		 ...
		 //	       File_Pull_Menu();
	     // case char(77) :
	      case char(27) :  active_status_bar(2,1);  //PROGRAMMER
			       MAINMENU(3); //PROGRAMMER
	      //====================================
	      case char(72) : index = (index == 1)    ? PROGRAMMER_Size1 :
			      index-1;
			      break;
	      case char(80) : index = (index == PROGRAMMER_Size1) ? 1    :
			      index+1;
			      break;
	      case char(13) : switch(index){
				       case 1 : _setcursortype(_NORMALCURSOR);
					       HTUT();	 break;
				       case 2 : _setcursortype(_NORMALCURSOR);  File_Pull_Menu(); menu(list_Cap,list,size,1);break;
				       case 3 : _setcursortype(_NORMALCURSOR); MAINMENU(3);		     break;
				       case 4 : _setcursortype(_NORMALCURSOR);   MAINMENU(3);break;
				}
	 }
